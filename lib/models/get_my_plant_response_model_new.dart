...
//
//     final getMyPlantResponseModelNew = getMyPlantResponseModelNewFromJson(jsonString);

import 'dart:convert';

GetMyPlantResponseModelNew getMyPlantResponseModelNewFromJson(String str) => GetMyPlantResponseModelNew.fromJson(json.decode(str));

String getMyPlantResponseModelNewToJson(GetMyPlantResponseModelNew data) => json.encode(data.toJson());
...
class GetMyPlantResponseModelNew {
    ...
    factory GetMyPlantResponseModelNew.fromJson(Map<String, dynamic> json) => GetMyPlantResponseModelNew(
